...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		n1 = 55;
		n2 = 45;
		pISum->lpVtbl->SumOfTwoIntigers(pISum, n1, n2, &sum);
		wsprintf(str, TEXT("Sum of %d and %d is: %d"), n1, n2, sum);
		MessageBox(hwnd, str, TEXT("SUM"),MB_OK);

		pISum->lpVtbl->QueryInterface(pISum,&IID_ISum, (void **)&pISubtract);
		pISubtract->lpVtbl->SubOfTwoIntigers(pISubtract,n1, n2, &subtract);
