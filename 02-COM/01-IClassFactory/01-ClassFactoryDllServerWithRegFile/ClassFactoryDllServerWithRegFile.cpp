...
//CoClass //meaning == COM chaa class and concrete class mhanun coclass

class CSumSubtract: public ISum, ISubtract //iSum kivaa iSub mhnje rajesh pradhan aani CSumSubtract mhnje patil kivaa kulkarni jo doghinnaa impliment karto
{
private:
	//declaration
	long m_cRef;
...
public:
	//constructor
	CSumSubtract(void); // void is for the backward compebility
