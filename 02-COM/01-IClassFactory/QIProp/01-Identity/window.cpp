...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		pISubtract->QueryInterface(IID_IUnknown, (void**)&pIUnknownFromISub);

		if (pIUnknownFromISum == pIUnknownFromISub)
		{
			MessageBox(hwnd, TEXT("Both Are Same"), TEXT("Indicating That Identity Is Proven"), MB_OK);
		}
